...
public class LITCogliLattimoWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITCogliLattimoWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITCogliLattimoWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITCogliLattimoWLAIW/InitOutcome.xml").getDocumentElement();
